...
{
    [TestMethod]
    public void ProjectBoundary_WhenProjectIsEngine_ReferencesOnlyApplicationAndDomain()
    {
        ...
        AssertProjectReferences("ParityBench.NET.Engine", "ParityBench.NET.Engine.csproj", expectedReferences);
    }
