...
{
    [TestMethod]
    public void ProjectBoundary_WhenProjectIsInfrastructure_ReferencesOnlyApplicationAndDomain()
    {
        ...
        AssertProjectReferences("ParityBench.NET.Infrastructure", "ParityBench.NET.Infrastructure.csproj", expectedReferences);
    }
