...
{
    [TestMethod]
    public void ProjectBoundary_WhenProjectIsApplication_ReferencesOnlyDomain()
    {
        string[] expectedReferences = new[] { @"..\ParityBench.NET.Domain\ParityBench.NET.Domain.csproj" };

        AssertProjectReferences("ParityBench.NET.Application", "ParityBench.NET.Application.csproj", expectedReferences);
    }
