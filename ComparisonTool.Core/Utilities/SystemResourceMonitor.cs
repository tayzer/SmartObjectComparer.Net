...
public class SystemResourceMonitor
{
    ...
    public double GetCpuUsage()
    {
        ...
        try
        {
            ...
            cachedCpuUsage = Math.Min(100, Math.Max(0, cpuUsageTotal));
        ...
        {
            logger.LogWarning(ex, "Error getting CPU usage, returning default");
    ...
    public double GetMemoryUsage()
    {
        ...
        try
        {
            ...
            cachedMemoryUsage = Math.Min(100, Math.Max(0, usagePercentage));
        ...
        {
            logger.LogWarning(ex, "Error getting memory usage, returning default");
            return 50; // Default to 50% if we can't determine actual usage
        }
    }
    ...
    public long CalculateAverageFileSizeKb(IEnumerable<string> filePaths, int sampleSize = 20)
    {
        ...
        {
            logger.LogWarning(ex, "Error calculating average file size");
            return 0;
        }
    }
