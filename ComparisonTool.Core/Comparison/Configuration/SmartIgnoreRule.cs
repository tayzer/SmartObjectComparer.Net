...
public static class SmartIgnorePresets
{
    ...
    /// </summary>
    public static List<SmartIgnoreRule> IgnoreIdFields => new List<SmartIgnoreRule>()
    {
    ...
    /// </summary>
    public static List<SmartIgnoreRule> IgnoreTimestamps => new List<SmartIgnoreRule>()
    {
    ...
    /// </summary>
    public static List<SmartIgnoreRule> IgnoreMetadata => new List<SmartIgnoreRule>()
    {
    ...
    /// </summary>
    public static Dictionary<string, List<SmartIgnoreRule>> AllPresets => new Dictionary<string, List<SmartIgnoreRule>>(StringComparer.Ordinal)
    {
